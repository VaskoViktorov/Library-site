...
$('div.dropdown').hover(function(){$(this).find('.drop').stop(!0,!0).delay(100).fadeIn(500)},function(){$(this).find('.drop').stop(!0,!0).delay(100).fadeOut(500)});$(document).ready(function(){$('.closed').hide();$('.open').hide();var d=new Date();var dayOfWeek=d.getUTCDay();var hour=d.getUTCHours();var mins=d.getUTCMinutes();var status='open';if(dayOfWeek!==6&&dayOfWeek!==0&&hour>=9&&hour<18){if(hour==='9'&&mins<'00'){status='closed'}else{status='open'}}else if(dayOfWeek===6&&hour>=9&&hour<14){if(hour==='9'&&mins<'00'){status='closed'}else{status='open'}}else{status='closed'}
